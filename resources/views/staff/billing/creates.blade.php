...
@section('content')
            ...
            <div class="row">
                <div class="col-md-5">
                    <select name="tests[]" id="test-name" class="test_name select_test">
                        <option value="test">Select Bill</option>
                ...
                <div class="col-md-5">
                    <input type="text" name="bill_price[]" class="test_price form-control">
                </div>
                <div class="col-md-2">
    ...
    <form action="{{ url('staff/patient/bill/save') }}" method="post">
        @csrf
            ...
            <div class="tests">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <h3 class="my-auto">Upload Bill</h3>
                        <hr />
                        @include('subviews.patient_details')

                        <button class="btn btn-danger w-100 my-3" id="add-test">Add New Bill</button>
                        <div id="wrapper">
    ...
    @push('scripts')
        <script>
            ...
            $(wrapper).on("keyup", ".test_price", function(e) {
                e.preventDefault();
